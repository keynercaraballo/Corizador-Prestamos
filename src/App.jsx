...
function App() {
  ...
  //Creando variables que no se van modificar 
  const MIN=0;
  const MAX= 20000;
  const STEP = 100;

  function handleChange(e) {
    setCantidad(+e.target.value);//con el + lo convertimos a numero entero 
  ...
  return (
    <div className="my-20 max-w-lg mx-auto bg-white shadow p-10">
      ...
      <input type="range" 
        className="w-full h-6 bg-gray-300 accent-lime-500 hover:accent-lime-700"
      ...
      <p className='text-center my-10 text-4xl font-extrabold text-indigo-600'>{  formatearDinero(cantidad)}</p>
